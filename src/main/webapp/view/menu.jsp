...
<fmt:setLocale value="${requestScope.locale}" scope="session"/>
...
<ul>
    ...
    <li><a href="${pageContext.request.contextPath}/view/examRegistration.jsp><fmt:message key="exam_registration"/>Registration for exam</a></li>
